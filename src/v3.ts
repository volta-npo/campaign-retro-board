export const v3 = {
  "productName": "Campaign Retro Board",
  "productTier": "release",
  ...
  "capabilities": [
    "Domain-specific workbench: Campaign Learning Board",
    "Operational table: Campaign experiments",
  ...
  "releaseChecklist": [
    ...
    "Learning Completeness reaches production threshold",
    "Metric Integrity is documented with evidence",
    "Next Experiment Readiness has no unresolved blocker",
    "Retro report verified",
    "Metrics CSV verified",
    "Chapter lesson JSON verified"
  ],
  "operations": [
