  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify hypothesis tracker with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "results-capture",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify results capture with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "lesson-library",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify lesson library with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify next experiment queue with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
